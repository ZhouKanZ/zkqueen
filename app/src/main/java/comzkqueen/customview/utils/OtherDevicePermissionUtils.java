package comzkqueen.customview.utils;
 ...
 * @desc :
 */
public class OtherDevicePermissionUtils {

    private Context mContext;

    private OtherDevicePermissionUtils() {

    }

    public static OtherDevicePermissionUtils getInstance() {
        return PermissionUtilHolder.sInstance;
    }

    public OtherDevicePermissionUtils with(Context context) {
        mContext = context.getApplicationContext();
        return PermissionUtilHolder.sInstance;
    }

    private static class PermissionUtilHolder {
        private static final OtherDevicePermissionUtils sInstance = new OtherDevicePermissionUtils();
    }
     ...
     * @return
     */
    public boolean hasCameraAndAudioPermission() {
        try {
